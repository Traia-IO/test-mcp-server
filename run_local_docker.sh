...
# Script to build and run the test MCP Server locally in Docker
...
IMAGE_NAME="test-mcp-server"
CONTAINER_NAME="test-mcp-local"
HOST_PORT=${PORT:-8000}
CONTAINER_PORT=${PORT:-8000}

echo -e "${BLUE}🚀 Building and running test MCP Server...${NC}"
echo
